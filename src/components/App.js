...
setError(true)
    ...
    return (<div className="p-w-parent">
    <div id="purple-div">
    ...
    <div id="white-div">
      <div className="container">
        ...
        <p id="c-number">
          <span className="num-span" ref={myNumberRef1}>0000</span> &nbsp; &nbsp;
          <span className="num-span" ref={myNumberRef2}>0000</span> &nbsp; &nbsp;
          <span className="num-span" ref={myNumberRef3}>0000</span> &nbsp; &nbsp;
          <span className="num-span" ref={myNumberRef4}>0000</span>
        </p>
        <span id="right">
          ...
          <span>/</span>
          <span className="year-span" ref={myExpYear}>00</span>
        </span>
        <span id="left" ref={myNameRef}>JANE APPLESEED</span>
      </div>

      <div className="container c2">
        <img className="card-img" src={Img3} alt="card back side" />

        <span id="card-cvc" ref={myCvc}>000</span>
      </div>
